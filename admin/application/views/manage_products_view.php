    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="card">
					<form method="post" action="<?php echo base_url().'Products_controller/search_product' ?>" style="background-color: #f7f7f7;">
						<input type="text" name="searchstr" id="searchstr" value="<?php echo set_value('searchstr'); ?>" placeholder="Search Products" style="width:400px;height:38px;border:1px solid gray;border-radius:10px;margin-left:10px;" />
					...
					?>
						<tr>
							...
							<td><a style="color:#5a3031;border-bottom:1px solid;" href="<?php ?>">Add Images</a></td>
							<td>
							  <?php
								if($row->prod_status == 1){
							?>	
							  <a style="color:orange;border-bottom:1px solid;" href="<?php echo base_url().'Products_controller/update_status/'.$row->prod_id ?>">In-Active</a>
							   <?php
							}
							  
							  else{
							  	?> 
									<a style="color:blue;border-bottom:1px solid;" href="<?php echo base_url().'Products_controller/update_status/'.$row->prod_id ?>">Active</a>
								 <?php 
							}
							?>
							  <a style="color:red;border-bottom:1px solid;" href="<?php echo base_url().'Products_controller/trash_product/'.$row->prod_id ?>" onclick="return confirm('Are you sure to delete?')">Delete</a>
							  </td>
                          </tr>							
							<?php 
								$i++;
							...
							?>
							<tr>
							<td colspan="13"><p style="color:red;text-align:center">No records found..!</p></td></tr>
							  <?php
							}
							?>
                      </tbody>
