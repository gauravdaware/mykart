...
<head>
    ...
    <link href="<?php echo base_url().CSS_PATH.'/';?>lib/vector-map/jqvmap.min.css" rel="stylesheet">
...
<body>
           ...
           <div class="col-xl-3 col-lg-6">
                <section class="card">
                    <div class="twt-feed blue-bg">
                        ...
                        <div class="media">
                            <a href="#">
                                <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="<?php echo base_url().IMG_PATH.'/';?>admin.jpg">
                            </a>
                            <div class="media-body">
                                <h2 class="text-white display-6">Gaurav Daware</h2>
    ...
    <script src="<?php echo base_url().JS_PATH.'/';?>lib/chart-js/Chart.bundle.js"></script>
    <script src="<?php echo base_url().JS_PATH.'/';?>dashboard.js"></script>
    <script src="<?php echo base_url().JS_PATH.'/';?>widgets.js"></script>
    <script src="<?php echo base_url().JS_PATH.'/';?>lib/vector-map/jquery.vmap.js"></script>
    <script src="<?php echo base_url().JS_PATH.'/';?>lib/vector-map/jquery.vmap.min.js"></script>
    <script src="<?php echo base_url().JS_PATH.'/';?>lib/vector-map/jquery.vmap.sampledata.js"></script>
    <script src="<?php echo base_url().JS_PATH.'/';?>lib/vector-map/country/jquery.vmap.world.js"></script>
    <script>
        ( function ( $ ) {
            "use strict";
