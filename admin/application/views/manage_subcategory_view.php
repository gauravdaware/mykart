    ...
    ?>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="card">
					<form method="post" action="<?php echo base_url().'Subcategory_controller/search_subcategory'?>" style="background-color: #f7f7f7;">
						<input type="text" name="searchstr" id="searchstr" value="<?php echo set_value('searchstr'); ?>" placeholder=" Search Subcategory" style="width:400px;height:38px;border:1px solid gray;border-radius:10px;margin-left:10px;" />
                        ...
                        <div class="card-header">
                            <strong class="card-title">Manage Subcategories</strong>
                        </div>
                        <div class="card-body">
					...
					?>
						...
						?>
							...
							<?php
								if($row->sub_category_status == 1){
							?>	
							  <a style="color:orange;border-bottom:1px solid;" href="<?php echo base_url().'Subcategory_controller/update_status/'.$row->sub_category_id ?>">In-Active</a>
							  <?php
							}
							  
							  else{
							  	?>  
							<a style="color:blue;border-bottom:1px solid;" href="<?php echo base_url().'Subcategory_controller/update_status/'.$row->sub_category_id ?>">Active</a>
							<?php 
							}
							?>
							  <a style="color:red;border-bottom:1px solid;" href="<?php echo base_url().'Subcategory_controller/trash_subcategory/'.$row->sub_category_id ?>" onclick="return confirm('Move to trash?')">Trash</a>
							  </td>
                          </tr>	
						<?php 
						$i++;
