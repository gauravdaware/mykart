    ...
    ?>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="card">
					<form method="post" action="<?php echo base_url().'Categories_controller/search_category'?>" style="background-color: #f7f7f7;">
					...
					?>
						...
						?>
							...
							<?php
								if($row->category_status == 1){
							?>	
							  <a style="color:orange;border-bottom:1px solid;" href="<?php echo base_url().'Categories_controller/update_status/'.$row->category_id ?>">In-Active</a>
							  <?php
							}
							  
							  else{
							  	?>  
							<a style="color:blue;border-bottom:1px solid;" href="<?php echo base_url().'Categories_controller/update_status/'.$row->category_id ?>">Active</a>
							<?php 
							}
							?>
							  <a style="color:red;border-bottom:1px solid;" href="<?php echo base_url().'Categories_controller/trash_category/'.$row->category_id ?>" onclick="return confirm('Move to trash?')">Trash</a>
							  </td>
                          </tr>	
						<?php 
						$i++;
