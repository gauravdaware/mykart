...
<head>
    ...
    <title>Removed Subcategories</title>
    ...
    ?>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Removed Subcategories</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
                    <div class="card">
                    <form method="post" action="<?php echo base_url().'Subcategory_controller/trash_search_subcategory'?>" style="background-color: #f7f7f7;">
                        ...
                        <div class="card-header">
                            <strong class="card-title">Removed Subcategories</strong>
                        </div>
                        <div class="card-body">
                    ...
                    ?>
                        ...
                        ?>
                            ...
                            <td>  
                              <a style="color:red;border-bottom:1px solid;" href="<?php echo base_url().'Subcategory_controller/delete_subcategory/'.$row->sub_category_id ?>" onclick="return confirm('Are you sure?')">Delete</a>
                              <a style="color:blue;border-bottom:1px solid;" href="<?php echo base_url().'Subcategory_controller/restore_subcategory/'.$row->sub_category_id ?>">Restore</a>
                              </td>
                          </tr> 
                        <?php 
                        $i++;
